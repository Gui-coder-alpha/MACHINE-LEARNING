...
class Player:
    def __init__(self, screen, ML):
        colors = [["Dinosaur_game_ML/Dinosaur_Images/Black_Dinosaur(1).png", "Dinosaur_game_ML/Dinosaur_Images/Black_Dinosaur(2).png"],
        ["Dinosaur_game_ML/Dinosaur_Images/Purple_Dinosaur(1).png", "Dinosaur_game_ML/Dinosaur_Images/Purple_Dinosaur(2).png"],
        ["Dinosaur_game_ML/Dinosaur_Images/Red_Dinosaur(1).png", "Dinosaur_game_ML/Dinosaur_Images/Red_Dinosaur(2).png"],
        ["Dinosaur_game_ML/Dinosaur_Images/Green_Dinosaur(1).png", "Dinosaur_game_ML/Dinosaur_Images/Green_Dinosaur(2).png"],
        ["Dinosaur_game_ML/Dinosaur_Images/Pink_Dinosaur(1).png", "Dinosaur_game_ML/Dinosaur_Images/Pink_Dinosaur(2).png"],
        ["Dinosaur_game_ML/Dinosaur_Images/Cian_Dinosaur(1).png", "Dinosaur_game_ML/Dinosaur_Images/Cian_Dinosaur(2).png"],
        ["Dinosaur_game_ML/Dinosaur_Images/Blue_Dinosaur(1).png", "Dinosaur_game_ML/Dinosaur_Images/Blue_Dinosaur(2).png"],
        ["Dinosaur_game_ML/Dinosaur_Images/Yellow_Dinosaur(1).png", "Dinosaur_game_ML/Dinosaur_Images/Yellow_Dinosaur(2).png"]]
