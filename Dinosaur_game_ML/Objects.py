...
class Blocks:
    def __init__(self):
        ...
        self.image_spike = pygame.image.load("Dinosaur_game_ML/Dinosaur_Images/yep.png").convert_alpha()
        self.image_one_formated = pygame.transform.scale(self.image_spike, (100, 150))
        self.image_bird = pygame.image.load("Dinosaur_game_ML/Dinosaur_Images/bird.png").convert_alpha()
        self.image_two_formated = pygame.transform.scale(self.image_bird, (150, 100))
        self.spike_carpet = pygame.image.load("Dinosaur_game_ML/Dinosaur_Images/spike_carpet.png").convert_alpha()
        self.spike_carpet_formated = pygame.transform.scale(self.spike_carpet, (300, 150))

        self.orb = pygame.image.load("Dinosaur_game_ML/Dinosaur_Images/orb.png").convert_alpha()
